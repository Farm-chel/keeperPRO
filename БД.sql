...
/****** Object:  Database [хранительПРО]    Script Date: 27.04.2025 11:23:14 ******/
CREATE DATABASE [хранительПРО]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'хранительПРО', FILENAME = N'D:\managment studio\MSSQL16.SQLEXPRESS\MSSQL\DATA\хранительПРО.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'хранительПРО_log', FILENAME = N'D:\managment studio\MSSQL16.SQLEXPRESS\MSSQL\DATA\хранительПРО_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
